...
def draw_labels(self) -> None:
    ...
    # -----------------------------------------------------------------------------------------------------------------
        ...
        self.window_surface.blit(main_music_val_label, (500, 140))  # РАЗМЕЩЕНИЕ ЧИСЛОВОГО ЗНАЧЕНИЯ МУЗЫКИ В МЕНЮ
        self.window_surface.blit(game_music_val_label, (500, 440))  # РАЗМЕЩЕНИЕ ЧИСЛОВОГО ЗНАЧЕНИЯ МУЗЫКИ В ИГРЕ

        self.window_surface.blit(main_label, (self.w // 90, 100))  # РАЗМЕЩЕНИЕ НАДПИСИ "МУЗЫКА В МЕНЮ"
        self.window_surface.blit(game_label, (self.w // 90, 400))  # РАЗМЕЩЕНИЕ НАДПИСИ "МУЗЫКА В ИГРЕ"
    ...
    # -----------------------------------------------------------------------------------------------------------------
        ...
        for race in range(5):  # ПЕРЕБОР 5 ЛУЧШИХ ЗАБЕГОВ
            ...
            self.window_surface.blit(current_result, (pos_x, start_pos_y + 100 * race))  # РАЗМЕЩЕНИЕ ДАННЫХ В ТОПЕ
